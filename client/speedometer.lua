...
function Speedometer:Render()
    ...
    Render:FillArea( bar_pos + Vector2( 1, 1 ), final_pos, Color( 0, 0, 0 ) )
...
function Speedometer:GameRender()
    ...
    Render:FillArea( bar_pos + Vector3( 1, 1, 4 ), 
        Vector3( bar_len, 16, 0 ),
        col )

    Render:FillArea( bar_pos + Vector3( 1, 1, 2 ), 
